...
import RentalRequestCard from "./rental-request-admin-card";
import RentalRequestList from "./rental-request-admin-list";
// import RentalRequestList from "./rental-request-list";

export default function RentalRequestAdminView({ rentalRequests }: any) {
